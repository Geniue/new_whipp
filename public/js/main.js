...
const container = document.querySelector(".mobile-toggle-menu");
const sub_menu_container = document.querySelector(".service-mob-menu");

function toggleClass(e) {
    e.classList.toggle("toggle-anime-mobile-menu");
...
document.querySelector(".toggle-menu-mob").addEventListener("click", () => {
    toggleClass(container);
});

document.querySelectorAll(".sub-menu-service-btn").forEach((btn) => {
    btn.addEventListener("click", (e) => {
        console.log(e.target.id);
        document.querySelectorAll(".service-mob-menu").forEach((container) => {
            if (e.target.id === container.dataset.id) {
                e.target.classList.toggle("toggle-up-down-sub-icon");
                container.classList.toggle("toggle-anime-sub-ser");
            }
        });
    });
});
