...
class StripePaymentsController extends Controller
{
    ...
    {
        return view('dashboard.stripe.payment');
    }
    ...
    public function presubmit(Request $request)
    {
        ...
        $date_ned = $date->format('m-d-Y h:i A');
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="padding: 0;">
                                                ...
                                                >
                                                    <img
                                                        src="https://whippdigital.com/assets/imgs/logos/whipp_logo_white.png"
                                                        alt="whippdigital.com"
                                ...
                                <table width="100%" style="background: #f9f9f9; border-bottom: 1px solid #eee; border-collapse: collapse; color: #999;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td align="right" width="50%" style="padding: 20px;">Thanks for using <span class="il">whippdigital.com</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
                                        ...
                                        <tr>
                                            <td width="40%" valign="top" style="padding: 10px 0;">
                                                ...
                                                <p style="color: #666; font-size: 12px; font-weight: normal; margin-bottom: 10px;">
                                                    Please visit our
                                                    <a
                                                        href="https://whippdigital.com/contact-us"
                                                        style="color: #666;"
                                                        target="_blank"
                                                    >
                                                        Support Center
                                            ...
                                            <td width="40%" valign="top" style="padding: 10px 0;">
                                                <h4 style="margin: 0;"><span class="il">WhippDigital,</span> LLC</h4>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
        ...
        return view('dashboard.stripe.stripe_pay', compact('pending', 'amount', 'client_secret', 'uniq', 'date', 'amountnn', 'date_ned'));
    ...
    public function success(Request $request)
    {
        ...
        if ($payment->success == 'no') {
            ...
            Mail::send('app.emails.payment_email', array(
                ...
                $message->to('stuart.emmons@gmail.com', 'WhippDigital')
                    ...
                    ->subject("WhippDigital Payment Submitted");
            ...
            if ($payment->email != "Not found") {
                Mail::send('app.emails.payment_email', array(
                    ...
                    $message->to($payment->email, 'WhippDigital')
                        ->subject("WhippDigital Payment Successfull");
                    $message->from("support@whippdigital.com",'WhippDigital');
                });
            }
        ...
        return view('dashboard.stripe.pay_success', compact('uniqId'));
    }
}
