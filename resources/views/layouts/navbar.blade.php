...
<header class="bg-light py-1 py-xl-3 position-sticky top-0" style="z-index: 99999">
    <nav class="wd-nav-section-container mx-auto d-flex align-items-center justify-content-between">
        <!-- logo -->
        <div class="d-flex">
            <div class="logo">
                <a href="/" class="main-logo">
                    <svg xmlns="http://www.w3.org/2000/svg" width="612" height="356" viewBox="0 212.5 612 356">
                        <path
        ...
        <!-- links & contact -->
        <div class="wd-menu-li-row d-flex align-items-center pt-3">
            <!-- links -->
            <div class="wd-menu-li-co justify-content-center align-items-center pe-5">
                <ul class="wd-nav-links d-flex align-items-center gap-4">
                    ...
                    <li class="nav-menu-child">
                        ...
                        <ul class="sevice-hover-expand tri-ico">
                            <li class="hover-ver2 new-nav-hover">
                    ...
                    <li class="nav-menu-child">
                        <div class="wd-nav-link position-relative">
                            <a href="{{ route('about-us') }}">
                                <span class="wd-nav-text"> about </span>
                            </a>
                        </div>
                    </li>
                    <li class="nav-menu-child">
                        <div class="service-has-expand wd-nav-link position-relative">
                            <a href="{{ route('services') }}">
                                <span class="wd-nav-text"> learn </span>
                            </a>
                        </div>
                        <ul class="sevice-hover-expand tri-ico">
                            <li class="hover-ver2 new-nav-hover">
                                <a href="{{ route('blog') }}"><i class="seoicon-button"></i>
                                    Blog
                                </a>
                            </li>
                            <li class="hover-ver2">
                    ...
                    <li class="nav-menu-child">
                        <div class="wd-nav-link position-relative">
                            <a href="{{ route('contact') }}">
                                <span class="wd-nav-text"> contact</span>
                            </a>
                        </div>
                    </li>
                </ul>
    ...
    <div class="mobile-toggle-menu">
        <ul class="mobile-toggle-menu-lists">
            ...
            <li class="expand-serivce-area-mob">
                <span class="custom-arrow sub-menu-service-btn" id="myitem3"></span>

                <a href="#" class="mob-service-link-aco"> Learn </a>

                <ul data-id="myitem3" class="service-mob-menu">
                    <li class="hover-ver2 ">
                        <a href="{{ route('blog') }}"><i class="seoicon-button"></i>
                            Blog
                        </a>
