...
<header class="bg-light py-1 py-xl-3 position-sticky top-0" style="z-index: 99999">
  <nav class="wd-nav-section-container mx-auto d-flex align-items-center justify-content-between">
    ...
    <div class="wd-menu-li-row d-flex align-items-center pt-3">
      <!-- links -->
      <div
        class="wd-menu-li-co justify-content-center align-items-center pe-5"
      >
      ...
      <div class="d-flex gap-3 ps-4 pb-2">
        ...
        <a
          href="tel:909-434-4334"
          class="fs-4 wd-num-phone"
          style="color: #2f2c2c"
        >
          909-434-4334
        </a>
        <a
          ...
          class="menu-icon-trigger toggle-menu-mob showhide"
        >
          <span
  ...
  <div class="mobile-toggle-menu">
    <ul class="mobile-toggle-menu-lists">
      <li class="expand-serivce-area-mob">
        <span class="custom-arrow sub-menu-service-btn"></span>

        <a href="{{route('services')}}" class="mob-service-link-aco"> Serivces </a>

        <ul class="service-mob-menu">
          <li class="megamenu-mob-item-info-title">
            <h5 class="">List of Services</h5>
          </li>
