        ...
        <div class="container py-5 custom-text">
            <div class="d-flex flex-column flex-lg-row gap-3 py-5 justify-content-center">
                <div
                    ...
                    <img width="600" src="{{ asset('assets/imgs/whipp_images/Virtual Assistant Service/Real Estate Virtual Assistant/v1/the-receptionist-is-working-in-a-restaurant-that-i-2023-06-12-20-25-53-utc.jpg') }}" alt="" />
                </div>
    ...
    <section>
        <div class="container py-5 custom-text">
            <div class="d-flex flex-column-reverse flex-lg-row gap-3 py-5 justify-content-center">
                ...
                <img width="600" src="{{ asset('public/assets/imgs/whipp_images/Virtual Assistant Service/Virtual Personal Assistant/v1/business-customer-service-concept-2021-08-28-11-37-12-utc.jpg') }}" alt="" />
            </div>
            </div>
        </div>
    </section>
