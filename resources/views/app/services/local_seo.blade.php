...
<meta name="title" content="Local SEO | {{ env("APP_NAME") }}  ">
...
<meta property="og:site_name" content="Local SEO | {{ env("APP_NAME") }} ">
<meta property="og:title" content="Local SEO | {{ env("APP_NAME") }} ">
...
<meta name="twitter:title" content="Local SEO | {{ env("APP_NAME") }} ">
...
<meta itemprop="name" content="Local SEO | {{ env("APP_NAME") }} ">
        ...
        <div class="wrap">
            <div>
                <p id="breadcrumbs" class="fs-5"><span><span><a class="fw-medium custom-text-2" href="/">Home</a></span> » <span
                            class="breadcrumb_last" aria-current="page"> Local SEO</span></span></p>
    ...
    <section style="background-color: #f3f3f3;">
        <div class="container py-4 ">
            ...
            <div class="d-flex  py-3">
                <button class="mx-auto  px-3 cta-btn-btn col-12 col-md-6 fw-bold col-xl-4   d-inline-block py-2 rounded-5 text-uppercase iwantgrow_btn " href="#">TALK WITH ONE OF OUR  <br>    Local SEO EXPERTS</button>
            </div>
        </div>
        </div>
    </section>
