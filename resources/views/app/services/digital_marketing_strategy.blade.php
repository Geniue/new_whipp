...
@section('title')
    Digital Marketing Strategy | {{ env("APP_NAME") }} 
...
<meta name="title" content="Digital Marketing Strategy | {{ env("APP_NAME") }}  ">
<meta name="description" content="Craft a winning digital marketing strategy to shine in the competitive online landscape. Align with your brand's core, engage your audience, and adapt to evolving digital trends for sustainable growth and lasting influence.">
<meta name="keywords" content="Digital Marketing Strategy, online landscape, brand's core, target audience, digital trends, sustainable growth, enduring influence">

<link rel="canonical" href="{{ url()->current() }}">

<meta property="og:site_name" content="Digital Marketing Strategy | {{ env("APP_NAME") }} ">
<meta property="og:title" content="Digital Marketing Strategy | {{ env("APP_NAME") }} ">
<meta property="og:description" content="Craft a winning digital marketing strategy to shine in the competitive online landscape. Align with your brand's core, engage your audience, and adapt to evolving digital trends for sustainable growth and lasting influence.">
...
<meta name="twitter:title" content="Digital Marketing Strategy | {{ env("APP_NAME") }}">
...
<meta itemprop="name" content="Digital Marketing Strategy | {{ env("APP_NAME") }} ">
<meta itemprop="url" content="{{ url()->current() }}">
<meta itemprop="thumbnailUrl" content="{{ asset('assets/imgs/whipp_images/digital_marketing/Digital Marketing Strategy/v1/digital-marketing-strategy-2021-08-28-05-58-19-utc.jpg') }}">
<meta itemprop="image" content="{{ asset('assets/imgs/whipp_images/digital_marketing/Digital Marketing Strategy/v1/digital-marketing-strategy-2021-08-28-05-58-19-utc.jpg') }}">
<link rel="image_src"   href="{{ asset('assets/imgs/whipp_images/digital_marketing/Digital Marketing Strategy/v1/digital-marketing-strategy-2021-08-28-05-58-19-utc.jpg') }}">
        ...
        <div class="wrap">
            <div>
                <p id="breadcrumbs" class="fs-5"><span><span><a class="fw-medium custom-text-2" href="/">Home</a></span> » <span
                            class="breadcrumb_last" aria-current="page">Digital Marketing Strategy</span></span></p>
    ...
    <section style="background-color: #f3f3f3;">
        <div class="container py-4 ">
            ...
            <div class="d-flex  py-3">
                <button class="mx-auto  px-3 cta-btn-btn col-12 col-md-7 fw-bold col-xl-5   d-inline-block py-2 rounded-5 text-uppercase iwantgrow_btn " href="#">TALK WITH ONE OF OUR <br> Digital Marketing Strategy EXPERTS</button>
            </div>
        </div>
        </div>
    </section>
