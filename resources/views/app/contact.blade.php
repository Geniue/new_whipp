  ...
  <div class="container py-5">
    <div class="row gap-5 gap-lg-0 justify-content-center">
      ...
      <div class="col-lg-8 px-4">
        <form
          class="wp-contact-form custom-bg-1 rounded-2 p-3 d-flex flex-column gap-4"
          action="/"
        >
          <!-- first name and last name -->
          <div>
            <p>Name <span class="required-ico"> * </span></p>
            <div
              class="d-flex flex-column flex-lg-row justify-content-between m-0 gap-3 w-100"
            >
            ...
            <ul class="gfield_checkbox row" id="input_15_8">
              ...
              <li class="col-12 col-sm-6 col-lg-4 gchoice gchoice_15_8_6">
                ...
                <label
                  ...
                  id="label_15_8_6"
                  class="gform-field-label gform-field-label--type-inline"
                  >Conversion Rate Optimization (CRO)</label
                >
              </li>
              <li class="col-12 col-sm-6 col-lg-4 gchoice gchoice_15_8_7">
                ...
                <label
                  ...
                  id="label_15_8_7"
                  class="gform-field-label gform-field-label--type-inline"
                  >Reputation / Reviews Management</label
                >
              </li>
          ...
          <div>
            ...
            <div class="gchoice gchoice_15_35_1 py-2">
              <input
                ...
                name="input_35.1"
                type="checkbox"
                value="Were you referred to Thrive?"
                id="choice_15_35_1"
                tabindex="126"
              />
              <label for="choice_15_35_1" id="label_15_35_1" class="ms-1"
                >Were you referred to Thrive?</label
              >
            </div>
          </div>
        ...
        <div class="fl-rich-text custom-text">
          ...
          <p>
            <img
              decoding="async"
              loading="lazy"
              class="alignnone size-full wp-image-58657"
              src="https://thriveagency.com/files/clutch-top-seo-2022-231x250-1.png"
              alt="Top SEO Companies Thrive Agency"
              width="231"
              height="250"
              srcset="
          ...
          <p>
            <img
              decoding="async"
              loading="lazy"
              class="size-full wp-image-47117 alignnone"
              src="https://thriveagency.com/files/IFA-Logo-placement.png"
              alt="International Franchise Association"
              width="184"
              height="110"
              srcset="
          ...
          <p>
            <img
              decoding="async"
              loading="lazy"
              class="alignnone wp-image-43644 size-full"
