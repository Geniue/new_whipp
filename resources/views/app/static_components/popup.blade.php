                ...
                <div class="text-center d-flex flex-column gap-4">
                    ...
                    <strong>
                     ...
                     <div class="d-flex flex-column flex-md-row gap-3  justify-content-center py-2">
                        ...
                        <button  id="close_popup_pg" class="w-100 px-4 shadow lettalkbtn_hasarrow px-2 cta-btn-btn  mx-auto d-flex justify-content-center align-items-center gap-2 py-2   rounded-5 text-uppercase fw-bold close_btn">No, I don't like to save!</button>
