...
@section('content')
        ...
        <div class="container  custom-text pt-5 pt-md-0">
            ...
            <div class="d-flex flex-column flex-lg-row gap-3  justify-content-center py-2 pt-md-0">
                ...
                data-background-image="{{asset('assets/imgs/smok.png')}}"
                    ...
                    class="max-lg-ms-100px overflow-hidden  max-mb-h-600px bacsrpre-sp lozad py-2  mx-auto  col-12 px-md-0 col-md-10 col-lg-6 col-xl-5 d-flex flex-column justify-content-center align-items-center">
                    <div class="">
    ...
    <section style="background: linear-gradient(180deg, rgb(255, 255, 255) 0%, rgba(48, 162, 255, 0.57) 50%, rgb(255, 255, 255) 100%);">
