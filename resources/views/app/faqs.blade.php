...
<meta name="title" content="FAQ's | {{ env("APP_NAME") }} ">
...
<meta property="og:site_name" content="FAQ's | {{ env("APP_NAME") }}">
<meta property="og:title" content="FAQ's | {{ env("APP_NAME") }}">
...
<meta itemprop="name" content="FAQ's | {{ env("APP_NAME") }}">
