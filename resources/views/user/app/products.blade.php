                        ...
                        <td>
                            ...
                            @if($boolInv)
                                ...
                                @else
                                    ...
                                    @else
                                        <a href="{{ route('receipt', $invoice->uniqId) }}" type="_blank" class="btn btn-primary">Your Receipt</a>
                                    @endif
                            ...
                            @else
                                @if($stat == "open")
                                    <a href="{{ route('user.pay', $invoice->uniqId) }}" class="btn btn-primary">Pay Now</a>
                                @else
                                    <a href="{{ route('receipt', $invoice->uniqId) }}" type="_blank" class="btn btn-primary">Your Invoice</a>
                                @endif
                            @endif
                        </td>
                    </tr>
