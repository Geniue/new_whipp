            ...
            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row container-padding" width="640" style="width:640px;max-width:640px;" Simpli>
                ...
                <tr>
                    <td align="center" class="center-text">
                        <img style="width: 400px;border:0px;display: inline!important;" src="https://luminaconstruction.com/assets/logo/LuminaTemLogo.webp" width="120" border="0" editable="true" Simpli data-image-edit  Simpli alt="logo">
                    </td>
                </tr>
                <tr>
                    <td height="30" style="font-size:30px;line-height:30px;" Simpli>&nbsp;</td>
                                                            ...
                                                            <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" class="row m-padding-top20" width="235" style="width:235px;max-width:235px;">
                                                                <tr>
                                                                    <td class="center-text" Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:24px;font-weight:700;font-style:normal;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                                        <singleline>
                                                                            <div mc:edit Simpli>
                                                                                Invoice No# <strong style="color:#1898c2;">{{$invoice->uniqId}}</strong>
                                                                            </div>
                                                                        </singleline>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td class="center-text" Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                                        <singleline>
                                                                            <div mc:edit Simpli>
                                                                                {{\Carbon\Carbon::parse($invoice->service_date)->format('d/m/Y')}}
                                                                            </div>
                                                                        </singleline>
                                                                    </td>
                                                                </tr>
                                                            ...
                                                            <table border="0" align="right" cellpadding="0" cellspacing="0" role="presentation" class="row" width="235" style="width:235px;max-width:235px;">
                                                                ...
                                                                <tr>
                                                                    <td class="center-text" Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:16px;line-height:20px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                                                        <singleline>
                                                                            <div mc:edit Simpli>
                                                                                {{$invoice->name !=null ? $invoice->name:''}} <br>
                                                                                {{$invoice->send_to!=null ? $invoice->send_to:''}}<br>
                                                                            </div>
                                                                        </singleline>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td align="center">
                                                                        ...
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" width="100" style="width:100px;max-width:100px;">
                                                                            ...
                                                                            @if($invoice->surchage!=0.00 || $invoice->surchage!=null)
                                                                            <tr>
                                                                                <td Simpli align="right" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:30px;font-weight:700;font-style:normal;color:#00000c;text-decoration:none;letter-spacing:0px;">
                                                                                    <singleline>
                                                                                        <div mc:edit Simpli>
                                                                        ...
                                                                        <table border="0" align="left" cellpadding="0" cellspacing="0" role="presentation" width="70" style="width:70px;max-width:70px;">
                                                                            ...
                                                                            <tr>
                                                                                <td Simpli align="left" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:20px;line-height:30px;font-weight:400;font-style:normal;color:#00000c;text-decoration:none;letter-spacing:0px;">
                                                                                    <singleline>
                                                                                        <div mc:edit Simpli>
                                                                                            $ {{number_format($invoice->surchage, 2)}}
                                                                                        </div>
                                                                                    </singleline>
                                                                                </td>
                                                                            </tr>
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="520" style="width:520px;max-width:520px;">
                                        <tr>
                                            <td align="center" height="80" Simpli style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:24px;line-height:32px;font-weight:700;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;height:80px;border-radius: 80px;" bgcolor="#1898c2">
                                                <singleline>
                                                    <div mc:edit Simpli>
                                                        TOTAL: $ {{number_format($invoice->total + $invoice->surchage, 2)}}
                                                    </div>
                                                </singleline>
                                            </td>
                                        </tr>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="480" style="width:480px;max-width:480px;">
                                        <tr>
                                            <td class="center-text" Simpli align="center" style="font-family:'Catamaran',Arial,Helvetica,sans-serif;font-size:14px;line-height:26px;font-weight:400;font-style:italic;color:#333333;text-decoration:none;letter-spacing:0px;">
                                                <singleline>
                                                    <div mc:edit Simpli>
                                                        If you have any Questions about this invoice, please contact us at 347-871-6530 or sales@pristinegreencleaning.com<br>Thank you very much for doing business with us.
                                                    </div>
                                                </singleline>
                                            </td>
                                        </tr>
